...
public class UsersController : BaseController
{
    ...
    public async Task<IActionResult> GetAllUser([FromQuery] GetAllUserRequest request, CancellationToken cancellationToken)
    {
        ...
        var data = _mapper.Map<List<GetAllUserResponse>>(response);

        var result = new PaginatedList<GetAllUserResponse>(data, response.Count, command.PageNumber, command.PageSize);
